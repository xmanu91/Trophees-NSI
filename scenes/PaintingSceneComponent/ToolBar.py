...
class ToolBar():
    def __init__(self, canva: Canva, spriteGroup: pygame.sprite.Group, theme: str):
        ...
        postIt = Image("assets/images/post-it.png", pygame.Rect(5, 15, 391*0.5, 124*0.5))

        eraserSprite = Image("assets/images/gomme.png", pygame.Rect(0, 0, 155, 50))
        self.eraser = Button(pygame.Rect(-50, 91, 155, 50), lambda: self.changeTool('eraser'), eraserSprite.image, eraserSprite.image, (-44, 91), "")

        brushSprite = Image("assets/images/pinceau.png", pygame.Rect(0, 0, 225, 25))
        self.brush = Button(pygame.Rect(-50, 172, 225, 25), lambda: self.changeTool('brush'), brushSprite.image, brushSprite.image, (-44, 172), "")

        colorPickerSprite = Image("assets/images/pipette.png", pygame.Rect(0, 0, 250, 98))
        ...
        bucketSprite = Image("assets/images/seau.png", pygame.Rect(0, 0, 225, 225))
