...
class JoinRoomScene(Scene):
    def __init__(self, sceneManager : SceneManager, username : str, roomManager: RoomManager):
        ...
        self.joinRoomButton = Button(pygame.rect.Rect(self.screenWidth * 0.68, self.screenHeight * 0.1 - 25, 120, 50), self.joinRoom, None, None, None, "Join", defaultColor=(255,255,255),  hoverColor=(119,169,198),textColor=(0,0,0), fontSize= 25)
        self.createRoomButton = Button(pygame.rect.Rect(self.screenWidth * 0.82, self.screenHeight * 0.1 - 25, 120, 50), self.createRoom, None, None, None, "Create", defaultColor=(255,255,255),  hoverColor=(119,169,198),textColor=(0,0,0), fontSize= 25)
...
class RoomCard(pygame.sprite.Sprite):
    def __init__(self, size : pygame.Rect, roomName : str, roomID : int, roomManager: RoomManager, sceneManager: SceneManager):
        ...
        self.button = Button(
            ...
            None, 
            "Join", 
            defaultColor=(164, 212, 162), 
            hoverColor=(119, 161, 117),
            textColor=(0,0,0), 
            fontSize= 25)
