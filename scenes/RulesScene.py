...
class RulesScene(Scene):
    def __init__(self, sceneManager: SceneManager, roomManager, previousScene):
        ...
        self.text = Text("Comment jouer ?", 40, (self.screenWidth/2, self.screenHeight*0.1), pygame.Color(0,0,0), True)
        
        self.one = Text("1. Choisissez un pseudo", 20, getScalingFactors(135, 200, self.screenWidth, self.screenHeight), pygame.Color(0,0,0), True)
        self.two = Text("2. Créez/Rejoingnez une room", 20, getScalingFactors(450, 250, self.screenWidth, self.screenHeight), pygame.Color(0,0,0), True)
        self.three = Text("3. Dessinez", 20, getScalingFactors(750, 220, self.screenWidth, self.screenHeight), pygame.Color(0,0,0), True)
        self.four = Text("4. Votez", 20, getScalingFactors(230, 450, self.screenWidth, self.screenHeight), pygame.Color(0,0,0), True)
        self.five = Text("5. Gagnez !", 20, getScalingFactors(560, 460, self.screenWidth, self.screenHeight), pygame.Color(0,0,0), True)
