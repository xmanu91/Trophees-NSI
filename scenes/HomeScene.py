...
class HomeScene(Scene):
    def __init__(self, sceneManager: SceneManager, roomManager: RoomManager):
        ...
        playButton = Button(pygame.rect.Rect(screenWidth / 2 - 200, screenHeight * 0.63 - 37.5, 400,75), self.joinRoom, None, None, None, "PLAY !", defaultColor=(255,255,255),  hoverColor=(119,169,198),textColor=(0,0,0), fontSize= 25)
