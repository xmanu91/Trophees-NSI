...
class HomeScene(Scene):
    def __init__(self, sceneManager: SceneManager, roomManager: RoomManager):
        ...
        self.usernameInput = TextInput(pygame.rect.Rect(screenWidth / 2 - 200, screenHeight * 0.45 - 25, 400, 50), pygame.Color(0,0,0), pygame.Color(119,169,198), pygame.Color(255,255,255), pygame.Color(33,33,33, 50), placeholder="Entrez votre pseudonyme")
        playButton = Button(pygame.rect.Rect(screenWidth / 2 - 200, screenHeight * 0.63 - 37.5, 400,75), self.joinRoom, None, None, None, "JOUER !", defaultColor=pygame.Color(255,255,255),  hoverColor=pygame.Color(119,169,198),textColor=pygame.Color(0,0,0), fontSize= 25)
