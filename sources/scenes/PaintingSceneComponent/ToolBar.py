...
class ToolBar():
    def __init__(self, canva: Canva, spriteGroup: pygame.sprite.Group, theme: str):
        ...
        self.background = Image("data/backgrounds/brown paper.png", pygame.Rect(0, 0, 200, 900))
        self.spriteGroup.add(self.background)

        postIt = Image("data/images/post-it.png", pygame.Rect(5, 15, 391*0.5, 124*0.5))

        eraserSprite = Image("data/images/gomme.png", pygame.Rect(0, 0, 155, 50))
        self.eraser = Button(pygame.Rect(-50, 91, 155, 50), lambda: self.changeTool('eraser'), eraserSprite.image, eraserSprite.image, (-44, 91), "")

        brushSprite = Image("data/images/pinceau.png", pygame.Rect(0, 0, 225, 25))
        self.brush = Button(pygame.Rect(-50, 172, 225, 25), lambda: self.changeTool('brush'), brushSprite.image, brushSprite.image, (-44, 172), "")

        colorPickerSprite = Image("data/images/pipette.png", pygame.Rect(0, 0, 250, 98))
        ...
        bucketSprite = Image("data/images/seau.png", pygame.Rect(0, 0, 225, 225))
