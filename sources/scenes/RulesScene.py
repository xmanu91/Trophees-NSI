...
class RulesScene(Scene):
    def __init__(self, sceneManager: SceneManager, roomManager, previousScene):
        ...
        self.background = Image("data/backgrounds/paperBackground_1.png", pygame.Rect(0,0, self.screenWidth, self.screenHeight))
        ...
        self.image1 = Image("data/images/help1.png", pygame.Rect(getScalingFactorsX(20, self.screenWidth), getScalingFactorsY(75, self.screenHeight), 250*1.2, 90*1.2))
        self.image2 = Image("data/images/help2.png", pygame.Rect(getScalingFactorsX(340, self.screenWidth), getScalingFactorsY(100, self.screenHeight), 200*1.2, 110*1.2))
        self.image3 = Image("data/images/help3.png", pygame.Rect(getScalingFactorsX(610, self.screenWidth), getScalingFactorsY(50, self.screenHeight), 210*1.2, 130*1.2))
        self.image4 = Image("data/images/help4.png", pygame.Rect(getScalingFactorsX(120, self.screenWidth), getScalingFactorsY(260, self.screenHeight), 200*1.1, 160*1.1))
        self.image5 = Image("data/images/help5.png", pygame.Rect(getScalingFactorsX(420, self.screenWidth), getScalingFactorsY(275, self.screenHeight), 230*1.2, 140*1.2))
