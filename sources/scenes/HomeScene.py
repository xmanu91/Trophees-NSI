...
class HomeScene(Scene):
    def __init__(self, sceneManager, roomManager):
        super().__init__()
        screenWidth, screenHeight = sceneManager.surface.get_width(), sceneManager.surface.get_height()
        self.sceneManager = sceneManager
        self.roomManager = roomManager
        background = Image('data/backgrounds/paperBackground_9.png', pygame.Rect(0,0, screenWidth, screenHeight))
        
        self.title = Image('data/backgrounds/title.png', pygame.Rect(screenWidth / 2 - 520/2, screenHeight * 0.06, 520, 153))
